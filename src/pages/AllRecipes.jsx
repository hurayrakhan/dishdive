        ...
        <div className="max-w-screen-xl mx-auto">
          ...
          <div className="flex flex-wrap  items-center mb-8 gap-4">
            ...
            >
              ...
              {[...new Set(initialRecipes.map((r) => r.cuisine))].map(
                (cuisine) => (
            ...
            <input
              ...
              className="px-4 py-2 border flex-1 border-gray-300 text-black rounded-lg shadow-sm w-64"
            />
          ...
          <div
            className={`${
              gridView ? 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8' : 'flex flex-col gap-6'
            }`}
          >
            {filteredRecipes.map((recipe) => (
              <Fade key={recipe._id}>
                <div
                  className={`relative bg-white rounded-3xl border border-gray-200 group overflow-hidden shadow-md hover:shadow-blue-400 transition-all duration-500 ${
                    gridView ? 'h-[380px]' : 'flex h-[280px]'
                  }`}
                >
